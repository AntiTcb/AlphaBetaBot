...
namespace AlphaBetaBot.Data.Migrations
{
    ...
    [Migration("20201013014331_TentativeSignup")]
    partial class TentativeSignup
    {
            ...
            modelBuilder.Entity("AlphaBetaBot.Data.Guild", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 10, 13, 1, 43, 31, 472, DateTimeKind.Unspecified).AddTicks(7354), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("AlphaBetaBot.Data.Raid", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 10, 13, 1, 43, 31, 464, DateTimeKind.Unspecified).AddTicks(3760), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("AlphaBetaBot.Data.User", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 10, 13, 1, 43, 31, 453, DateTimeKind.Unspecified).AddTicks(5302), new TimeSpan(0, 0, 0, 0, 0)));
